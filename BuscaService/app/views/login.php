<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if ($rowCliente) {
            ...
            // Faça o que for necessário com os dados da tabela "cliente"
            // Exemplo: $rowCliente['nome'], $rowCliente['perfil']
            ...
            // Faça o que for necessário com os dados da tabela "profissional"
            // Exemplo: $rowProfissional['nome'], $rowProfissional['perfil']
