...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "INSERT INTO `busca_service1`.`profissional` (`nome`, `titulo`, `email`, `senha`, `cpf`, `telefone`, `telefone2`, `cep`, `estado`, `cidade`, `bairro`, `logradouro`, `fotoprin`, `descricaonegocio`, `fotosec`, `fotosec2`, `status`)
                    VALUES (:nome, :titulo, :email, :senha, :cpf, :telefone, :telefone2, :cep, :estado, :cidade, :bairro, :logradouro, :fotoprin, :descricaonegocio, :fotosec, :fotosec2, :status)";
