                ...
                <form action="" method="post" class="box">
                    <fieldset>
                        <legend><b>Atualizar Serviço</b></legend>
                            ...
                            <div class="inputBox">
                                <input type="text" name="nome" id="nome" class="inputUser" autofocus
                                    value="<?=isset($row)? $row['nome'] : ''?>">
                                <label for="nome" class="labelInput">Nome</label>
                            </div>

                            <div class="inputBox">
                                <input type="text" name="categoria" id="categoria" class="inputUser" autofocus
                                    value="<?=isset($row)? $row['categoria'] : ''?>">
